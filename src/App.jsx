...
<div className="fixed inset-0 bg-black/50 pointer-events-none z-0" />
      ...
      <div className="relative z-10">
        ...
        <motion.nav 
          ...
          className="fixed top-0 left-0 w-full z-50 bg-[#0D0D0D]/85 backdrop-blur-md border-b border-[#F9F6F0]/5 px-6 py-4 flex justify-between items-center"
        >
        ...
        <section id="reviews" className="py-24 px-6 max-w-5xl mx-auto text-center">
          ...
          <div className="bg-[#111111]/90 backdrop-blur-sm border border-[#F9F6F0]/5 p-8 md:p-12 rounded-2xl relative">
        ...
        <footer className="bg-[#080808]/95 py-12 px-6 border-t border-[#F9F6F0]/5 text-center text-xs text-[#F9F6F0]/40">
